...
SECRET_KEY = 'django-insecure-*=#n_fc$wuc#h2=e)vx6fnkwy5k%g3julj$9mx^i8w^9=ch(&8'
...
MIDDLEWARE = [
    ...
    'club.middleware.JWTAuthenticationMiddleware',
]
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, "static"),  # Add this line to specify your static files location
]
